...
public abstract class PackagePart implements RelationshipSource, Comparable<PackagePart> {
	 ...
	 *             If a writing operation is done on a extractor only package or
   ...
   public PackagePart getRelatedPart(PackageRelationship rel) throws InvalidFormatException {
	...
	/**
	 * Get the input stream of this part to extractor its content.
	 *
	...
	public OutputStream getOutputStream() {
		...
		// If this part is a zip package part (extractor only by design) we convert
	 ...
	 * as in a waiting state to extractor or write, the must to empty their
	 * respective buffer.
	 */
