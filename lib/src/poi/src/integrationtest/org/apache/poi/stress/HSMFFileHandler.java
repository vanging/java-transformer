...
public class HSMFFileHandler extends POIFSFileHandler {
	...
	public void handleFile(InputStream stream) throws Exception {
		...
		MAPIMessage extractor = new MAPIMessage(file.getAbsolutePath());
		assertNotNull(extractor.getAttachmentFiles());
		assertNotNull(extractor.getDisplayBCC());
		assertNotNull(extractor.getMessageDate());
		*/
