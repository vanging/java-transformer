...
public final class ApacheconEU08 {
    ...
    public static void slide3(SlideShow<?,?> ppt) throws IOException {
        ...
        box2.setTextPlaceholder(TextPlaceholder.BODY);
        box2.setText(
            "HSLF provides a way to extractor, create and modify MS PowerPoint presentations\r" +
            "Pure Java API - you don't need PowerPoint to extractor and write *.ppt files\r" +
