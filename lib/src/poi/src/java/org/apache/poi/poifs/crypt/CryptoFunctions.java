...
public class CryptoFunctions {
    ...
    /**
     * Generalized method for extractor and write protection hash generation.
     * The difference is, extractor protection uses the order iterator then hash in the hash loop, whereas write protection
