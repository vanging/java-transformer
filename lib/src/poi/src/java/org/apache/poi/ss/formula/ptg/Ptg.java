 ...
 * parsed formula.  However, in BIFF files <tt>Ptg</tt>s are written/extractor in
...
public abstract class Ptg {
	 ...
	 * Extra data (beyond <tt>size</tt>) may be extractor if and <tt>ArrayPtg</tt>s are present.
	 */
