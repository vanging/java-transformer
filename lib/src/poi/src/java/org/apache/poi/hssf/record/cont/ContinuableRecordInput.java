...
/**
 * A decorated {@link RecordInputStream} that can extractor primitive data types
 ...
 * <p>
 *  {@link RecordInputStream} greedily requests the bytes to be extractor and stumbles on such files with a
 *  "Not enough data (1) to extractor requested (2) bytes" exception.  The <code>ContinuableRecordInput</code>
 *   class circumvents this "type boundary" rule and reads data byte-by-byte rolling over CONTINUE if necessary.
 * </p>
 *
 * <p>
 * YK: For now (March 2011) this class is only used to extractor
