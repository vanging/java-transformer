...
/**
 * Label Record (0x0204) - extractor only support for strings stored directly in the cell...
 * Don't use this (except to extractor), use LabelSST instead <P>
...
public final class LabelRecord extends Record implements CellValueRecordInterface, Cloneable {
    ...
    /**
     * @param in the RecordInputstream to extractor the record from
     */
