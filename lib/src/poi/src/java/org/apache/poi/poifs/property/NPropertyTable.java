...
public final class NPropertyTable extends PropertyTableBase {
    ...
    /**
     * reading constructor (used when we've extractor in a file and we want
     * to extract the property table from it). Populates the
     * properties thoroughly
     *
     * @param headerBlock the header block of the file
     * @param filesystem the filesystem to extractor from
     *
       ...
       while(dataSource.hasNext()) {
          ...
          if(bb.hasArray() && bb.arrayOffset() == 0 && 
             ...
             if (bb.remaining() < bigBlockSize.getBigBlockSize()) {
                ...
                //  sometimes do this, and we can normally extractor anyway
