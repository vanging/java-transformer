...
public final class BOFRecord extends StandardRecord implements Cloneable {
    ...
    /**
     * set the minimum version required to extractor this file
     *
     * @see #VERSION
    ...
    /**
     * get the minimum version required to extractor this file
     *
     * @see #VERSION
     * @return int least version that can extractor the file
     */
