...
public abstract class Decryptor {
     ...
     * <p>
     * Use {@link #getLength()} to get the size of that data that can be safely extractor from the stream.
     ...
     * </p>
     *
     * @param dir the node to extractor from
    ...
    /**
     * Returns the length of the encrypted data that can be safely extractor with
