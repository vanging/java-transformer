...
public class StringUtil {
     ...
     * String and return.
     * (In Excel terms, extractor compressed 8 bit unicode as a string)
     *
     * @param string byte array to extractor
     * @param offset offset to extractor byte array
     * @param len    length to extractor byte array
