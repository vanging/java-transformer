 ...
 * documents. Once all the listeners have been registered, the extractor()
 * method is called, which results in the listeners being notified as
 * their documents are extractor.
 *
...
public class POIFSReader
{
        ...
        throws IOException
    {
        ...
        // extractor the header block from the stream
        HeaderBlock header_block = new HeaderBlock(stream);

        // extractor the rest of the stream into blocks
     ...
     * @exception IllegalStateException if extractor() has already been
     *                                  called
     */
