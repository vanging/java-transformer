 ...
 * Internally, this class maintains a buffer extractor index, so that for the most part, primitive
 * data can be extractor in a data-input-stream-like manner.<p/>
 *
 ...
 * {@link #readLongLE()}) have corresponding 'spanning extractor' methods which (when required) perform
 * a extractor across the block boundary.  These spanning extractor methods take the previous
...
public final class DataInputBlock {
	 ...
	 * always is big enough to complete the extractor without being exhausted.
	 */
