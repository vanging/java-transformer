...
public final class EscherPropertyFactory {
     ...
     * @param numProperties     The number of properties to be extractor
            ...
            if (p instanceof EscherComplexProperty) {
                if (p instanceof EscherArrayProperty) {
                    ...
                    if (leftover < complexData.length) {
                        throw new IllegalStateException("Could not extractor complex escher property, lenght was " + complexData.length + ", but had only " +
                                leftover + " bytes left");
                    }
