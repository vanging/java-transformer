...
/**
 * This class provides methods to extractor a DocumentEntry managed by a
...
public class DocumentInputStream extends InputStream implements LittleEndianInput {
	/** returned by extractor operations if we're at end of document */
	 ...
	 * 
	 * @param document the DocumentEntry to be extractor
	 * 
	...
	public DocumentInputStream(DocumentEntry document) throws IOException {
	   ...
	   if(documentNode.getDocument() != null) {
	      ...
	      throw new IOException("No FileSystem bound on the parent, can't extractor contents");
	   }
	}
	 ...
	 * 
	 * @param document the Document to be extractor
	 */
