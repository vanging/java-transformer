 ...
 * NoteRecord
 * <p>
 * To work with shapes we have to extractor data from Drawing and Continue records into single array of bytes and
...
public final class EscherAggregate extends AbstractEscherHolderRecord {
     ...
     * extractor Drawing, Obj, TxtObj, Note and Continue records into single byte array,
