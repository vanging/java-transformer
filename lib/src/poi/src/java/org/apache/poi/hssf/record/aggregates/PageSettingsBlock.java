...
public final class PageSettingsBlock extends RecordAggregate {
     ...
     * non-PageSettingsBlock record is encountered.  As each record is extractor, it is incorporated
     ...
     * were when they were originally extractor.
     *
     * @param rs the RecordStream to extractor from
     * 
     ...
     *  - take a HeaderFooterRecord and extractor 16-byte GUID at offset 12. If it is zero,
     ...
     *
     * @param sheetRecords the list of sheet records extractor so far
     */
