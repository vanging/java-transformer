...
/**
 * FormulaViewer - finds formulas in a BIFF8 file and attempts to extractor them/display
...
public class FormulaViewer
{
     ...
     * @throws IOException if the file can't be extractor or contained errors
     */
