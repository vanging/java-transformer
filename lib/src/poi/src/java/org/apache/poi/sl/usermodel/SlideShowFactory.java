...
public class SlideShowFactory {
     ...
     *
     * @param fs The {@link NPOIFSFileSystem} to extractor the document from
     *
     ...
     *
     *  @param inp The {@link InputStream} to extractor data from.
     *
     *  @return The created SlideShow
     *
     *  @throws IOException if an error occurs while reading the data
     ...
     *
     *  @param file The file to extractor data from.
     *
     *  @return The created SlideShow
     *
     *  @throws IOException if an error occurs while reading the data
     ...
     *  @param file The file to extractor data from.
     *  @param password The password that should be used or null if no password is necessary.
     *  @param readOnly If the SlideShow should be opened in extractor-only mode to avoid writing back
