...
public class LittleEndian implements LittleEndianConsts
{
     ...
     *            Number of bytes to copy.
     * @throws IndexOutOfBoundsException
     *             - if extractor would cause access of data outside array bounds.
     */
     ...
     * 
     * @param stream
     *            the InputStream from which the int is to be extractor
     * @return the int (32-bit) value
     ...
     * 
     * @param stream
     *            the InputStream from which the long is to be extractor
     * @return the long (64-bit) value
     * @exception IOException
     *                will be propagated back to the caller
     * @exception BufferUnderrunException
     ...
     * 
     * @param stream
     *            the InputStream from which the short is to be extractor
     * @return the short (16-bit) value
     * @exception IOException
     *                will be propagated back to the caller
     * @exception BufferUnderrunException
