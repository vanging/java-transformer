...
public class VBAMacroReader implements Closeable {
     ...
     *
     * @param stream the inputstream to extractor from
     * @param length number of bytes to extractor from stream
     ...
     *
     * @param in the run-length encoded input stream to extractor from
    ...
    private static void readModule(RLEDecompressingInputStream in, String streamName, ModuleMap modules) throws IOException {
        ...
        if (module == null) {
            ...
            // Would adding module.extractor(in) here be correct?
        } else {
    ...
    private static void readModule(DocumentInputStream dis, String name, ModuleMap modules) throws IOException {
        ...
        if (module == null) {
            ...
            if (module.offset == null) {
                ...
                throw new IOException("Module offset for '" + name + "' was never extractor.");
            }
